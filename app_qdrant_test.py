...
def query():
    ...
    6. Only include URLs in your answer if they are directly relevant to the information you mention. 
        - If a chunk contains a fact that supports your answer, you may include the URL in parentheses immediately after that fact.
        - Do NOT list URLs that are unrelated or unnecessary.
    """
    ...
    """
        ...
        # Step 3: Call Deepseek without streaming
        messages = [
            {"role": "system", "content": system_prompt},
            {"role": "user", "content": user_prompt},
        ]
        ...
        answer = answer = generate_with_deepseek(system_prompt, user_prompt)
