...
def main():
    print(f"Looking for chunk with ID {CHUNK_ID_TO_INSERT}...")

    item = load_item_by_id(JSON_PATH, CHUNK_ID_TO_INSERT)
    if not item:
        print(f"❌ Chunk with ID {CHUNK_ID_TO_INSERT} not found.")
        return
    ...
    print(f"✅ Inserted chunk ID {item['id']} into Qdrant.")
